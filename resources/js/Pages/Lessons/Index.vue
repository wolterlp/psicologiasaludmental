            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-between mt-2" >
                        <Link v-if="lessons.current_page > 1" :href="lessons.prev_page_url" class="hover:bg-gray-100 py-2 px-4 rounded" >
                            PREVIOUS
                        </Link>    
                        <div class="placeholder"></div>
                        <Link v-if="lessons.current_page < lessons.last_page" :href="lessons.next_page_url" class="hover:bg-gray-100 py-2 px-4 rounded" >
                            NEXT
                        </Link>  
                    </div>
                </div>
